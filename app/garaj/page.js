...
async function RetrieveMechanicShops(){
    const mechanicShops = await prisma.shop.findMany()
    console.log(mechanicShops)


    return mechanicShops 
}


export default async function MechanicsViewPage(){


    let mecaniciNebuni = await RetrieveMechanicShops();
